...
// Left menu open/close
		...
		hamburger.addEventListener('click', function(){	leftNavbar.classList.toggle('left-nav-width');
		});
		
		hamburger.addEventListener('click', function(){	container.classList.toggle('body-when-mobile-menu-open');
		});		
